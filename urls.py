...
from .views import EventIndexView, EventListView, EventDetailView, EventCreateView, EventUpdateView, EventDeleteView, PastEventListView, CalendarView

app_name = 'events'

urlpatterns = [
    path('', EventIndexView.as_view(), name='index'),
